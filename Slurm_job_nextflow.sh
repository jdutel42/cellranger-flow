...
#SBATCH --mem=2G
#SBATCH --output=/home/dutel/Log/nextflow_controller/nextflow_controller_%x_%j.out
#SBATCH --error=/home/dutel/Log/nextflow_controller/nextflow_controller_%x_%j.err
