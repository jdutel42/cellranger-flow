...
process CELLRANGER_MKFASTQ {
    ...
    script:
        ...
        # Commenting out because error message 
        ...
        log_save "Cellranger mkfastq completed successfully for run_id = ${run_id} with FASTQ files generated in ${qc_output_dir}/fastq_output_${run_id}/"
