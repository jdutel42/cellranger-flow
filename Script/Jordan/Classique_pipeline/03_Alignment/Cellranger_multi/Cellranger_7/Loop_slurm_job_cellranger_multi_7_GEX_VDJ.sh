...
generate_slurm_script() {
    ...
    SLURM_SCRIPT="${PATH_SLURM_SCRIPTS}/Slurm_job_cellranger_multi_7_GEX_VDJ_${batch}_${TODAY}.sh"
...
#SBATCH --error=/home/dutel/log/${TODAY}.Slurm_job_cellranger_multi_7_GEX_VDJ_${batch}.%j.err
#SBATCH --output=/home/dutel/log/${TODAY}.Slurm_job_cellranger_multi_7_GEX_VDJ_${batch}.%j.out
